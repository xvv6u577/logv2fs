                ...
                <div className="container px-3 mx-auto">
                    ...
                    <form className="" onSubmit={handleAddNode}>
                        <div className="flex w-full mx-auto">
                            ...
                            <button type="button"
                                onClick={() => {
                                    // append {type, remark, domain, server_port, enable_subscription, uuid, path, sni} to nodes
...
const AddLegacyNode = () => {
    ...
    useEffect(() => {
        axios
            .get(process.env.REACT_APP_API_HOST + "7b3f3f", {
                headers: { token: loginState.token },
            })
            .then((response) => {
                setnodes(response.data);
    ...
    const handleAddNode = (e) => {
        ...
        axios({
            method: "put",
            url: process.env.REACT_APP_API_HOST + "v242j6",
            headers: { token: loginState.token },
            data: nodes,
        })
            .then((response) => {
    ...
    return (
        <>
            ...
            <section className="text-gray-400 bg-gray-900 body-font">
                <div className="container px-3 mx-auto">
                    <div className="flex flex-col text-center w-full my-5">
                        <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-white">legacy - Clash Nodes</h1>
                        {/* <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Current status of active nodes</p> */}
                    </div>
                    <div className="px-2 w-full mx-auto overflow-auto shadow-md">
                        <table className="table-auto w-full text-left whitespace-no-wrap">
