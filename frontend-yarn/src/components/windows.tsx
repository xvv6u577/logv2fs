...
function Windows() {
	...
	return (
		<div className="xl:container xl:mx-auto px-5 xl:px-20">
			...
			<p className="my-6 text-baseg font-normal text-gray-500 lg:text-base sm:px-16 xl:px-10 dark:text-sky-200">
				点按 Service Mode 右边的 Manage, 弹出的对话框！如果 Current Status 是 Inactive, 点按 Install 按钮。<br />
				服务安装成功后，程序会自动重启！<br /></p>
			...
			<p className="my-6 text-baseg font-normal text-gray-500 lg:text-base sm:px-16 xl:px-10 dark:text-sky-200">
				再次回到 General , Service Mode 右边的图标会变成绿色, Current Status 是 Active, 说明服务启动成功。<br />
				在 General 页面, 点击TUN Mode 右边的小齿轮，弹出的对话框，不用更改任何设置，点“保存”。<br /></p>
