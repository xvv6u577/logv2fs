...
const Menu = () => {
	...
	const handleWriteToDB = (e:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
		axios({
			method: "get",
		...
		<header className="text-gray-400 bg-gray-900 body-font">
			<div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
				<a href="/home" className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
					...
					<span className="ml-3 text-xl">Logv2ray Frontend</span>
				</a>
				...
				<span className="hover:text-white">Signed in as: <b>{loginState.jwt.Email}</b></span>
				<button
