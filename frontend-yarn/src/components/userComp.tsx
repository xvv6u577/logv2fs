...
interface HandleDisableNodeProps {
    email: string;
    node: string;
}

const UserComp: FunctionComponent<Props>  = (props) => {
    ...
    const handleOnline = (name: string) => {
        axios
    ...
    const handleOffline = (name: string) => {
        axios
    ...
    const handleDisableNode = ({ email, node }: HandleDisableNodeProps) => {
        axios
    ...
    const handleEnableNode = ({ email, node }: HandleDisableNodeProps) => {
        axios
...
const EditUser: FunctionComponent<EditUserProps> =({ btnName, user, editUserFunc }) => {
                                ...
                                <form className="space-y-6" onSubmit={handleEditUser}>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            name="used"
                                            onChange={onChange}
                                            placeholder={user.used.toString()}
                                            value={used}
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        />
                                    </div>
...
interface ConfirmDelUserProps {
    btnName: string;
    deleteUserFunc: () => void;
}

const ConfirmDelUser: FunctionComponent<ConfirmDelUserProps> = ({ btnName, deleteUserFunc }) => {
